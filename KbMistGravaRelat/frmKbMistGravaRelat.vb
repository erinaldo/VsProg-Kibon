Public Class frmKbMistGravaRelat

    Private Sub frmMistGravaRelat_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        'Simula
        'dpDataIni.Value = New Date(2014, 4, 17)
        'dpDataFim.Value = New Date(2014, 4, 18)
