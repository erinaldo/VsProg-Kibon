Module basRelat
    ...
    Function GeraRelat(DataIniRel As String, DataFimRel As String) As Boolean
        ...
        Dim PathnameMod As String = Util.UtAppPath & "\..\Bin\RelatModelos\KbMistGrava.xlsx"
        Dim PathnameRel As String = "C:\Tmp\MistGrava_" & DataHoraTxt & ".xlsx"
        ...
        Dim MyPlan As OfficeOpenXml.ExcelWorksheet = myEpplus.Workbook.Worksheets("RelatMist")
