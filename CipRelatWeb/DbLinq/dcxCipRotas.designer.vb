...
Namespace nsCipRotas
    ...
    #End Region
		...
		Public Sub New()
			MyBase.New(Global.System.Configuration.ConfigurationManager.ConnectionStrings("csCipRotas").ConnectionString, mappingSource)
			OnCreated
		End Sub
    ...
    #End Region
		...
		<Global.System.Data.Linq.Mapping.ColumnAttribute(Storage:="_lvalue", DbType:="Image", CanBeNull:=true, UpdateCheck:=UpdateCheck.Never)>  _
