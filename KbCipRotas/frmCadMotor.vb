Public Class frmCadMotor
    ...
    Private Sub RefreshGrid()
        ...
        If txtFiltro.Text = "" Then
            ...
            Else
                myReg = From It In Banco.MotCad Order By It.PlcNum, It.PlcIdx
            End If
        ...
        Else
            ...
            Else
                myReg = From It In Banco.MotCad Where It.Tag Like myFiltro Order By It.PlcNum, It.PlcIdx
            End If
    ...
    Private Sub butSalvar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butSalvar.Click
        ...
        If ItemNovo = False Then
            'Atualizacao - Update
            Dim myReg = From It In Banco.MotCad Where It.Tag.ToUpper = txtTag.Text.ToUpper
        ...
        Else
            'Novo - Insert
            Dim myTeste = From It In Banco.MotCad Where It.Tag.ToUpper = txtTag.Text.ToUpper
            ...
            Dim myRegNovo As New Geral.nsCipRotas.MotCad
            ...
            Banco.MotCad.InsertOnSubmit(myRegNovo)
    ...
    Private Sub butApagar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles butApagar.Click
        ...
        Dim myReg = From It In Banco.MotCad Where It.Tag.ToUpper = myTag.ToUpper

        Dim Ret As MsgBoxResult = MsgBox("Deseja realmente apagar o motor [ " & myTag.ToUpper & " ]?", _
                                        MsgBoxStyle.Critical + MsgBoxStyle.YesNo, "Atenção")

        If Ret = MsgBoxResult.Yes Then

            Banco.MotCad.DeleteAllOnSubmit(myReg)
